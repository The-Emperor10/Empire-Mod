...
namespace FactionColonies
{
    ...
    public class QuestPart_DeploySquad : QuestPart
    {
        ...
        public override void Notify_PawnKilled(Pawn pawn, DamageInfo? dinfo)
        {
            ...
            Mercenary mercenary = squad.AllDeployedMercenaries.FirstOrFallback(merc => merc.pawn == pawn);
            if (mercenary != null)
            {
                squad.Notify_MercenaryKilled(mercenary);
            }
        }
    ...
    {
        public static void FirstTick(FactionFC fc)
        {
            if(fc.settlements.Any(settlement => settlement.militarySquad.isDeployed));
                Find.WindowStack.Add(new EmpireUIMercenaryCommandMenu());
        }
    }
}
